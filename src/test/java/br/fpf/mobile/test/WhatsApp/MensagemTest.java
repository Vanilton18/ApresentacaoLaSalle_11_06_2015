...
public class MensagemTest extends AndroidDriverCreator {
	...
	/*
	 * OBS: Os elementos cuja ocorre iteração irão mudar de acordo com a versão
	 * do android e modelo de device
	 */

	@Test
	public void EnviarMensagemWhats() throws InterruptedException, IOException {
		WebDriverWait wait = new WebDriverWait(driver, 30);
		AndroidElement TituloApp = (AndroidElement) driver
				.findElementByXPath("//android.widget.TextView[@text='WhatsApp']");
		...
		driver.findElementByAndroidUIAutomator("new UiSelector().text(\"João Clineu\")").click();
